...
(function borderColorSelector () {
  let selectColor = document.getElementById('selectColor');
  let borderColor = document.getElementById('borderColor');
  let tweet = document.getElementById('tweet');
  // borderColor.addEventListener('change', applyColor)
  function applyColor() {
    console.log(borderColor.value)
    tweet.style.border = `3px solid ${borderColor.value}`
  }
  ...
  yellowBtn.addEventListener('click', ()=> tweet.style.border = `3px solid #f7d118`)
  blueBtn.addEventListener('click', ()=> tweet.style.border = `3px solid #1499ff`)
  redBtn.addEventListener('click', ()=> tweet.style.border = `3px solid #ec1818`)
  orangeBtn.addEventListener('click', ()=> tweet.style.border = `3px solid #f78708`)
